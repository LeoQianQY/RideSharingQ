...
public class BindPassenger2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt.setText("Please fasten your seatbelt");
        Button confirm = findViewById(R.id.confirmArrivalOfDriver);
        confirm.setOnClickListener(v -> new BindPassenger2Activity.ConfirmArrivalTask().execute(pid));
    ...
    public void mapIntent(){
        ...
        nextIntent.setClass(BindPassenger2Activity.this, MapActivity.class);
    ...
    public void nextIntent(){
        ...
        String pid = intent.getStringExtra("pid");
        Intent nextIntent = new Intent();
        nextIntent.setClass(BindPassenger2Activity.this, PFinishActivity.class);
